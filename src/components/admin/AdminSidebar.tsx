  ...
  return (
    <>
      ...
      <div
        ...
        xl:w-78 w-72 h-full bg-white border-r border-gray-100 
        flex flex-col p-8 overflow-y-auto theme-admin font-sans shadow-premium
      ...
      >
        ...
        <div className="mb-14 px-2 flex items-center justify-between">
          <div>
            ...
            <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mt-1.5 opacity-80">
              Management Panel
            </p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={onClose}
              className="lg:hidden p-4 bg-red-50 text-red-400 rounded-full border border-red-100 shadow-sm"
            >
              <X size={18} />
            </button>
          </div>
        ...
        <nav className="flex-1 space-y-4">
          <p className="px-6 text-[10px] font-black text-gray-300 uppercase tracking-[0.25em] mb-8">
            Core Management
          </p>
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                <div
                  className={`p-2.5 rounded-full transition-colors ${isActive ? "bg-white/20" : "bg-gray-100 group-hover:bg-white"}`}
                >
                  <Icon
                    size={18}
                ...
                <span
                  className={`tracking-tight text-sm ${isActive ? "font-black" : "font-bold"}`}
                >
                  {item.label}
                </span>
              </Link>
