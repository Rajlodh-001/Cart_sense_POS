    ...
    <div className="flex flex-col gap-2.5 group/field w-full animate-in fade-in duration-500" ref={containerRef}>
      ...
      <div className="relative">
        ...
        >
          ...
          {/* Right-Aligned Anti-Gravity Controls */}
          ...
          <div className="absolute top-full left-0 right-0 mt-4 bg-white/95 backdrop-blur-xl border border-gray-100 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] z-[100] p-4 animate-in slide-in-from-top-4 duration-500">
            ...
            <div className="max-h-60 overflow-y-auto custom-scrollbar flex flex-col gap-1">
              {filteredOptions.length > 0 ? (
                ...
                <div className="py-8 text-center text-[10px] font-black text-gray-300 uppercase tracking-widest">No matching frequencies</div>
              )}
            </div>
          </div>
        )}
